...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_BASE] = LAYOUT_all(
        ...
        KC_LCTL, KC_LOPT, KC_LCMD,                            KC_SPC,                             MO(_FN1), KC_RCMD, MO(_FN3), KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_FN1] = LAYOUT_all(
        ...
        _______, RGB_RMOD, RGB_VAD,  RGB_HUD, RGB_SAD, RGB_SPD, _______, KC_DOWN, KC_UP,   _______, _______,  _______,            _______,          _______,
        _______,           _______,  _______, _______, _______, NK_TOGG, KC_PGDN, KC_PGUP, _______, _______,  _______,            _______, _______,
    ...
    [_FN2] = LAYOUT_all(
        ...
        _______,           _______,  _______, _______, _______, _______, NK_TOGG, _______, _______, _______,  _______,            _______, DM_REC1,
        _______, _______,  _______,                             _______,                            _______,  _______,  _______,  _______, DM_REC2, DM_RSTP),
    ...
    [_FN3] = LAYOUT_all(
        ...
        RGB_TOG, RGB_MOD,  RGB_VAI,  RGB_HUI, RGB_SAI, RGB_SPI, _______, _______, _______, _______, _______,  _______,  _______,  _______,          DM_PLY1,
        _______, RGB_RMOD, RGB_VAD,  RGB_HUD, RGB_SAD, RGB_SPD, _______, _______, _______, _______, _______,  _______,            _______,          DM_PLY2,
        _______,           _______,  _______, _______, _______, _______, _______, _______, _______, _______,  _______,            _______, DM_REC1,
        _______, _______,  _______,                             _______,                            _______,  _______,  _______,  _______, DM_REC2, DM_RSTP)
